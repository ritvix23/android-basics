...
public final class GridListItemBinding implements ViewBinding {
  ...
  private GridListItemBinding(@NonNull MaterialCardView rootView, @NonNull TextView ageText,
      @NonNull ImageView dogImage, @NonNull TextView hobbiesText, @NonNull TextView nameText) {
  ...
  public static GridListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new GridListItemBinding((MaterialCardView) rootView, ageText, dogImage, hobbiesText,
          nameText);
    }

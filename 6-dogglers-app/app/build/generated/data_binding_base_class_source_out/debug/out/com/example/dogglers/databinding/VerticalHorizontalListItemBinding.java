...
public final class VerticalHorizontalListItemBinding implements ViewBinding {
  ...
  private VerticalHorizontalListItemBinding(@NonNull MaterialCardView rootView,
      @NonNull TextView ageText, @NonNull ImageView dogImage, @NonNull TextView hobbiesText,
  ...
  public static VerticalHorizontalListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.dog_image;
      ImageView dogImage = rootView.findViewById(id);
      if (dogImage == null) {
        break missingId;
      }
      ...
      return new VerticalHorizontalListItemBinding((MaterialCardView) rootView, ageText, dogImage,
          hobbiesText, nameText);
    }
